...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        // Invalid email or password, handle accordingly (e.g., display an error message)
...
<body>
    <div id="header" class="intro-bg">
        <div class="container">
            ...
            <div class="form">
                <form method="post">
                    <h4 class="aformh">Admin Login</h4>
                    <label>Email Address*</label>
                    <input type="email" name="email" placeholder="Enter Email Address" required>
                    <label>Password*</label>
                    <input type="password" name="password" id="password" placeholder="Enter Password" required>
                    <i class="fa-solid fa-eye" id="ashow-password"></i>
                    <div>
                        <input id="rem" type="checkbox">Remember
                    </div>
                    <a href="forget.php" id="aforget">forget Password?</a>
                    <button id="asignup" type="submit">Sign in</button>
                </form>
            </div>
        </div>
    </div>
