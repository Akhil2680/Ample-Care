            ...
            <div class="row">
                ...
                <div class="col-7">
                    <div class="nav justify-content-center">
                        <div class="nav">
                            <a href="index.html" class="nav-link white pt-3">Home</a>
                ...
                <div class="col-3">
                    <button class="mt-2 login-btn white"><a href="login.html" id="mlogin">Log in</a></button>
                    <button class="mt-2 login-btn white"><a href="Signup.html" id="mlogin">Sign Up</a></button>
                </div>
            </div>
            <div class="form">
                <form>
                    <h4 class="forget-heading">Forget Password</h4>
                    <p id="forget-msg">Enter the email address you see on domain. We'll send you a link to reset your password</p>
                    <label >Email Address*</label>
                    <input type="email" placeholder="Enter Email Address" required>
                   
                    <button id="reset-btn" type="submit">RESET PASSWORD</button>
                    <p id="forget-sin">Go back to <a href="login.html">Sign in</a></p>
                </form>
            </div>
        </div>
    </div>
